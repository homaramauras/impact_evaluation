...
dl_vars <- c("age_ben", "hh_men_21", "hh_men_min_21", "hh_women_min_21", "housing_index_stand", grep("^col_21", names(provida_df), value = TRUE))
...
# Run and display
dl_result  <- run_cem(provida_df, "dec_extent", dl_vars, "CEM (DL Covariates)")
all_result <- run_cem(provida_df, "dec_extent", all_vars, "CEM (All Covariates)")
